...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 15 juil. 2019 à 14:53
...
INSERT INTO `jcdd_contenu` (`id`, `jeu`, `femme`, `categorie`, `adresse`, `latitude`, `longitude`, `indice`, `solution`, `photo_lieu`, `photo_lieu_source`, `photo_lieu_licence`, `source_texte`, `photo_femme`, `photo_femme_source`, `photo_femme_licence`) VALUES
